    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_number', models.CharField(max_length=18, unique=True, verbose_name='Documento')),
                ...
                ('option', models.CharField(choices=[('1', 'Agência'), ('2', 'Cliente'), ('3', 'Parceiro')], max_length=8, verbose_name='Opção')),
            ...
            managers=[
                ('objects', accounts.managers.DefaultUserManager()),
            ],
        ),
    ]
