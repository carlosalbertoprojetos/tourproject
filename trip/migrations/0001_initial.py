<<<<<<< HEAD
# Generated by Django 4.0 on 2022-05-06 02:29
=======
# Generated by Django 4.0.3 on 2022-05-05 12:25
>>>>>>> precos
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
<<<<<<< HEAD
                ('cadpax', models.CharField(max_length=10, verbose_name='Categoria PAX')),
                ('season', models.CharField(max_length=255, verbose_name='Temporada')),
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
=======
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('cadpax', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trip.tripcategorypax', verbose_name='Categoria PAX')),
...
>>>>>>> precos
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trip_slug', models.CharField(max_length=100, verbose_name='Slug')),
                ('cadpax', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='cadpax_passeio', to='trip.tripcategorypax', verbose_name='CategoriaPAX')),
                ('trip', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='cadpax_passeio', to='trip.trip', verbose_name='Passeio')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='trip',
            name='cadpax',
            field=models.ManyToManyField(blank=True, related_name='catpax', through='trip.TripCadPaxTrip', to='trip.tripcategorypax', verbose_name='Categoria PAX'),
        ),
        migrations.AddField(
            model_name='trip',
            name='category',
