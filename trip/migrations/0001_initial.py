# Generated by Django 4.0.3 on 2022-05-25 19:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trip_option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trip.tripoption', verbose_name='')),
            ],
        ),
        migrations.CreateModel(
            name='TripCadPaxTrip',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cadpax', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trip.tripcategorypax')),
