# Generated by Django 4.0.3 on 2022-04-11 23:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occ_scale', models.CharField(choices=[('8', '8'), ('6', '6'), ('2', '2'), ('5', '5'), ('7', '7'), ('3', '3'), ('4', '4'), ('1', '1'), ('10', '10'), ('9', '9')], max_length=2, verbose_name='Escala de Ocupação diária (1 a 10)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trip_option', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='trip.tripoption', verbose_name='Opção de Passeio')),
            ],
        ),
        migrations.AddField(
            model_name='trip',
