    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trip.trip', verbose_name='Passeio')),
            ],
        ),
        migrations.CreateModel(
            name='TripPrice',
            fields=[
                ...
                ('cadpax', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='trip.tripcategorypax', verbose_name='Categoria PAX')),
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='season.season', verbose_name='Temporada')),
                ('trip_option', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='trip.tripoption', verbose_name='')),
            ],
        ),
        migrations.CreateModel(
            name='TripCadPaxTrip',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cadpax', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='trip.tripcategorypax')),
