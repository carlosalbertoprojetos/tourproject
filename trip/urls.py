...
from .views import (category_register, 
                    trip_create, trip_list, 
                    trip_update, trip_delete,
                    catpax_list, catpax_create,
                    catpax_update, catpax_delete,
                    price_trip_list, price_trip_create,
                    price_trip_update, price_trip_delete
                    )
