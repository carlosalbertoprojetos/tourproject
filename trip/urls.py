...
from .views import (trip_categorypax_list_create, trip_categorypax_update, trip_categorypax_delete,
                    ...
                    trip_price_list_create, trip_price_update, trip_price_delete, trip_price_update_all
                    )
...
urlpatterns = [
    ...
    path('<trip_id>/price_trip/edit1/', trip_price_update_all, name='trip_price_update1'),
    path('<trip_option_id>/price_tripop/edit/', trip_price_update, name='tripop_price_update'),
