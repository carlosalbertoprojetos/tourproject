...
def listTripPackage(request, city_destiny):
    ...
    # start_date = request.POST.get('id_date_arrive','')
    # end_date = request.POST.get('id_date_departure','')
...
#         resposta = {'start_date':start_date, 'end_date': end_date, 'passeios':[{'nome':'passeio1'}]}
