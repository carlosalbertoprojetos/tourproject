# Generated by Django 3.2.10 on 2022-01-24 18:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_kind', models.CharField(max_length=50, verbose_name='Tipo de documento')),
                ('document_number', models.CharField(max_length=18, null=True, unique=True, verbose_name='Número do Documento')),
                ('document_image', models.ImageField(blank=True, upload_to='images/%d/%m/%Y/')),
                ...
                ('option', models.CharField(choices=[('0', 'Admin'), ('2', 'Agência'), ('3', 'Fornecedor'), ('4', 'Agente')], max_length=8, verbose_name='Opção')),
